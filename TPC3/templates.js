...
exports.studentsListPage = function(slist, d){
    ...
    <html>
        ...
        <body>
            <div class="w3-card-4">
                ...
                <header class="w3-container w3-pale-blue">
                    <h1>Students List
                    <a class="w3-btn w3-round w3-blue" href="/alunos/registo">+</a>
                    </h1>
    ...
    pagHTML += `
            ...
            <h6><a href='/' class='w3-button w3-blue'>Voltar</a></h6>
            </div>
                <footer class="w3-container w3-pale-blue">
        ...
        <body>
            <div class="w3-card-4">
                ...
                <form class="w3-container" method="POST">
                    ...
                    <br>
                    <div>
                        <a class="w3-btn w3-green w3-mb-2" style="margin-left: 20px;" href="/alunos">Voltar</a>
                    </div>
                <br>
...
exports.studentFormEditPage = function(a, d){
    ...
    pagHTML += `
                    ...
                    <br/>
                    <button class="w3-btn w3-red w3-mb-2" type="submit">Salvar</button>
                </form>
                <br>
                    <div>
                        <a class="w3-btn w3-red w3-mb-2" style="margin-left: 20px;" href="/alunos">Voltar</a>
                    </div>
                <br>
...
exports.studentPage = function(aluno, d ){
    ...
    pagHTML +=     `</ul>
                ...
                <br>
                <a class="w3-btn w3-blue w3-mb-2" style="margin-left: 20px;" href="/alunos">Voltar</a>
                <br>
                <br>
            <footer class="w3-container w3-pale-blue">
                    <h5>Generated by EngWeb2025 in ${d}</h5>
